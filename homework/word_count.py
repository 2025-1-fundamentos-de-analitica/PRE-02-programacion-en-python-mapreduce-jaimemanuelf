...
##creo que este if name de abajo, debe ir al final unicamente"ya esta al final, verificar igual si borro el qe esta inmediatamente abajo de este comement
'''
...
# texto.
#el sum de abajo depende del contexto del problema, puede ser max o cualquier otro operador
#
